...
`This project and its ` [associated paper](https://www.alexmoica.com/publications/IAC-23,C2,IP,1,x76972.pdf) ` has been accepted to the International Astronautical Congress (IAC) 2023 🚀`
    <br />
  </p>
</div>
